      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="midnight-header p-8 rounded-lg">
            ...
            <p className="text-xl font-medium text-foreground max-w-3xl leading-relaxed tracking-wide antialiased" style={{ textShadow: 'none' }}>Discover your rights under federal credit laws and learn how creditors commonly violate consumer protections. Knowledge is power in credit repair.</p>
          </div>
        </div>

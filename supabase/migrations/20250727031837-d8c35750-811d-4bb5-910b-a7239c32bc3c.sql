...
-- Insert the 3 specified clients (they'll need to sign up first, but we'll prepare their data)
INSERT INTO public.clients (full_name, email_address, membership_plan) VALUES 
('Melvin Earl Milliner Jr.', 'melvin@example.com', 'Pro'),
('Phoebe Thomas', 'phoebe@example.com', 'Pro'), 
('Jadlyn Nicole Starkey', 'jadlyn@example.com', 'Basic')
